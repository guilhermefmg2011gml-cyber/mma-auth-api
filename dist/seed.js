...
export async function seedAdminIfEnabled() {
  ...
  `);
    ...
    const insertLawyer = db.prepare("INSERT OR IGNORE INTO lawyers (nome, oab_numero, oab_uf, tipo) VALUES (?,?,?,?)");
    const insertTarget = db.prepare("INSERT OR IGNORE INTO watch_targets (tipo, valor, ativo) VALUES (?,?,1)");
